	...
	public static void main(String args[])
	{
		...
		if (Monitor.IsRegistered() )
		{
			...
			while (!Done)
			{
				...
				System.out.println( "3: Configurar alarmas de seguridad");
				System.out.println( "4: Configurar rociador de agua");
				...
				if (Option.equals("3")){
					System.out.println("\nTeclee '1' para habilitar el subsistema de alarmas o teclee cualquier otro valor para deshabilitarlo");
					System.out.print("Ingrese su respuesta>>>");
					Option = UserInput.KeyboardReadString();
					if (Option.equals("1")){
						Monitor.EnableSecurityAlarms(true);
					}
					else{
						Monitor.EnableSecurityAlarms(false);
					}
					
				}

				if (Option.equals("4")){
					System.out.println("\tTeclee '1' para encender el rociador de agua o teclee cualquier otro valor para apagarlo");
					Option = UserInput.KeyboardReadString();
					if (Option.equals("1")){
						if (Monitor.IsPresentFire()){
							Monitor.EnableRociador(true);
						}
						else{
							System.out.println("No hay fuego presente, no es necesario encenderlo");
						}
					}	
					else{
						Monitor.EnableRociador(false);
					}
				}
				//////////// option X ////////////
