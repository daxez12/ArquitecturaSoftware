...
class FilterTemplate(FilterFramework):
    """ A template for creating filters. The details of threading, filter connections, input, and output
    ...
    should use the SourceFilterTemplate or SinkFilterTemplate as a starting point for creating source or sink
    filters.
        """
    def __init__(self):
    ...
    def run(self):
        """ Insert code for the filter operations here. Note that data must be received and sent one byte at a time. 
            This has been done to adhere to the pipe and filter paradigm and provide a high degree of portability between filters. 
            However, you must reconstruct data on your own. First we read a byte from the input	stream.
            """
        while True:
