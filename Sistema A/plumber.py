""" A template for creating a main thread that will instantiate and connect a set of filters.
...
if __name__ == "__main__":
        ...
        # filter1 = SourceFilter();    # This is a source filter
        # filter2 = MiddleFilter();    # This is a standard filter
        # filter3 = SinkFilter();      # This is a sink filter
        ...
        # filter2.connect(filter1); # This essentially says, "connect Filter2's intput port to Filter1's output port
