...
class FormatOutputFilter(FilterFramework):
    ...
    def run(self):
        ...
        print "{0}::FormatOutputFilter reading".format(self.getName())
        ...
        while True:
            try:
                ...
                while i < measurementLength:
                    ...
                    #Presentacion de los datos de Velocidad    
                    if idMeasurement == 1:
                    ...
                    #Presentacion de los datos de Altitud   
                    if idMeasurement == 2:
                        #convertimos la medida de 8 bytes en un arreglo de 8 bytes
                        byteArray = struct.pack("@Q", measurement) 
                    ...
                    #Presentacion de los datos de Inclinacion
                    if idMeasurement == 5:
                        #convertimos la medida de 8 bytes en un arreglo de 8 bytes
                        byteArray = struct.pack("@Q", measurement) 
                ...
                self.closePorts()
                print "{0}::FormatOutputFilter Exiting; bytes read: {1}".format(self.getName(), bytesRead)
                break